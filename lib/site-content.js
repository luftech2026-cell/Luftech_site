...
export const companyAddress =
  "Via Ca' Caprino, Sotto il Monte Giovanni XXIII, 24039 BG, Italia";

export const companyDetails = [
  { label: "Ragione sociale", value: "Lufcore" },
  { label: "P. IVA", value: "04908730163" },
  { label: "PEC", value: "infissi360@gail.com" },
  { label: "Sede", value: companyAddress },
];

export const companyStatusNote =
  "La struttura delle pagine legali e dei riferimenti di contatto e gia pronta per gli eventuali aggiornamenti societari successivi.";
